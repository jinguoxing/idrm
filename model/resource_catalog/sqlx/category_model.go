...
var _ resource_catalog.CategoryModel = (*CategoryModel)(nil)

type CategoryModel struct {
	conn sqlx.SqlConn
}

// NewCategoryModel 创建CategoryModel实例
func NewCategoryModel(conn *sql.DB) resource_catalog.CategoryModel {
...
// Insert 插入类别
func (m *CategoryModel) Insert(ctx context.Context, data *resource_catalog.Category) (*resource_catalog.Category, error) {
...
// FindOne 根据ID查找类别
func (m *CategoryModel) FindOne(ctx context.Context, id int64) (*resource_catalog.Category, error) {
...
func (m *CategoryModel) FindByCode(ctx context.Context, code string) (*resource_catalog.Category, error) {
	var category resource_catalog.Category
	query := `SELECT id, name, code, parent_id, level, sort, description, status, created_at, updated_at 
...
// Update 更新类别
func (m *CategoryModel) Update(ctx context.Context, data *resource_catalog.Category) error {
...
// FindAll 查找所有类别
func (m *CategoryModel) FindAll(ctx context.Context) ([]*resource_catalog.Category, error) {
...
func (m *CategoryModel) FindByParentId(ctx context.Context, parentId int64) ([]*resource_catalog.Category, error) {
	var categories []*resource_catalog.Category
	query := `SELECT id, name, code, parent_id, level, sort, description, status, created_at, updated_at 
...
// List 分页查询类别列表
func (m *CategoryModel) List(ctx context.Context, page, pageSize int) ([]*resource_catalog.Category, int64, error) {
	var categories []*resource_catalog.Category
	var total int64
...
func (m *CategoryModel) WithTx(tx interface{}) resource_catalog.CategoryModel {
...
// Trans 执行事务
func (m *CategoryModel) Trans(ctx context.Context, fn func(ctx context.Context, model resource_catalog.CategoryModel) error) error {
