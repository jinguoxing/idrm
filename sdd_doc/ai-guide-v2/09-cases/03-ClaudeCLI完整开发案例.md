...
# 生成requirements.md
claude --files "sdd_doc/spec/workflow/phase1-specify.md" \
       --files "sdd_doc/spec/workflow/ears-notation-guide.md" \
...
claude --files "specs/features/tag-management/requirements.md" \
       --files "sdd_doc/spec/quality/quality-gates.md" \
       < check_gate1.txt
...
```bash
claude --files "specs/features/tag-management/requirements.md" \
       --files "sdd_doc/spec/architecture/layered-architecture.md" \
       --files "sdd_doc/spec/architecture/dual-orm-pattern.md" \
       --files "sdd_doc/spec/workflow/phase2-design.md" \
...
# 生成并分割输出
claude --files "specs/features/tag-management/design.md" \
       --files "sdd_doc/spec/coding-standards/go-style-guide.md" \
...
claude --files "api/internal/logic/resource_catalog/tag/*.go" \
       --files "sdd_doc/spec/coding-standards/testing-standards.md" \
...
{
  "context_files": [
    "sdd_doc/spec/core/*.md",
    "sdd_doc/spec/architecture/*.md",
    "sdd_doc/spec/coding-standards/*.md"
  ],
...
claude --files "sdd_doc/spec/workflow/*.md" \
