...
参考：`sdd_doc/spec/constitution.md`
...
3. **双ORM模式**
   - 同时支持GORM和SQLx
   - 通过Factory模式选择
   - 参考：`sdd_doc/spec/architecture/dual-orm-pattern.md`
...
1. **编码规范** (参考：`sdd_doc/spec/coding-standards/`)
   - 所有公开项必须有中文注释
   - 函数长度 < 50行
   - 错误封装使用 %w
...
- **测试规范**: `sdd_doc/spec/coding-standards/testing-standards.md`
