...
```
# IDRM项目示例
@sdd_doc/spec/constitution.md 帮我实现功能
...
@sdd_doc/spec/coding-standards/error-handling.md
```
...
**提示词**：
```
@sdd_doc/spec/coding-standards/code-review-checklist.md
...
2. 重启Cursor
3. 明确引用规范文档：`@sdd_doc/spec/xxx.md`
...
- `sdd_doc/spec/constitution.md` - 项目宪章
